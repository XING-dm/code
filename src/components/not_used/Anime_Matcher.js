...
import Anime_Matcher_Check from './Anime_Matcher_Check'
import './style/Anime_Matcher.css'

function Anime_Matcher(){
    ...
    return (
        <div className="container">
            { items.map((item, index) => (
                <Anime_Matcher_Check key={index} item={item} id={index} handleClick={handleClick} />
            )) }
        </div>
    )
}

export default Anime_Matcher